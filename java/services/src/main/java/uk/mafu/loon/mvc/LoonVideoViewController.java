...
public class LoonVideoViewController extends AbstractController {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(LoonVideoViewController.class);
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response)
		...
		LoonVideo video = getDataService().getLoonVideo(pk);
