package uk.mafu.loon.events
{
	...
	public class ManyToManySavedEvent extends Event 
	{
		public static const NAME:String = Util.getFullClassName(ManyToManySavedEvent);
		private var parent_clazz:Class;
		private var parentId:Object;
		private var relationship:String;
		private var children:Array;
		
	 	public function ManyToManySavedEvent(
	 							parent_clazz:Class,
								parentId:Object,
								relationship:String,
								children:Array)
