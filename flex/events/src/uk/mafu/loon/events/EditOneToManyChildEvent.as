package uk.mafu.loon.events
{
	...
	public class EditOneToManyChildEvent extends Event 
	{
		...
		public static const NAME:String = Util.getFullClassName(EditOneToManyChildEvent);
		
		public function EditOneToManyChildEvent(child:Object,relationship:String,parent:Object) {
