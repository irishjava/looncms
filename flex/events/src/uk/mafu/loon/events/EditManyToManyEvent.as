package uk.mafu.loon.events
{
	...
	public class EditManyToManyEvent extends Event implements IExecutable
	{
		public var children:ArrayCollection,relationship:String,parent:Class,parentId:Object;
		public static const NAME:String = Util.getFullClassName(EditManyToManyEvent);
		
		public function EditManyToManyEvent(children:ArrayCollection,relationship:String,parent:Class,parentId:Object) {
		...
		public function isDuplicate(other:IExecutable):Boolean{
			...
			if(other is Util.getClass(this)){
				var otherEdit:EditManyToManyEvent = other as EditManyToManyEvent;
